...
const courses = [
    {
        urlCourseDetail:'bca-1st-semester-course-detail',
        urlCourse:'bca-1st-semester-course',
        title: "BCA 1st Semester",
        description: "Learn core computer concepts, mathematics, communication, and C programming — master problem-solving, professional skills, and programming fundamentals for a strong tech foundation.",
        offer: 92,
        newPrice: 40,
        oldPrice: 500,
        subjects: [
    ...
    try {
        for (const course of courses) {
            await Course.updateOne(
                { title: course.title }, // find course by title
                { $set: course }, // update all fields
                { upsert: true } // insert if not found
            );
            console.log(`✅ Upserted course: ${course.title}`);
        }

        console.log("\n🎯 All courses updated/inserted successfully!");
        process.exit(0);
    } catch (error) {
