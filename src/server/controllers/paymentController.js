...
//     if (!user) return { status: 401, body: { success: false, message: 'Not authorized' } };
//     if (!courseId) return { status: 400, body: { success: false, message: 'courseId required' } };

//     const course = await Course.findById(courseId);
//     if (!course) return { status: 404, body: { success: false, message: 'Course not found' } };
...
//     return { status: 200, body: { success: true, message: 'Payment verified, course unlocked', payment } };
// };
